...
def home_process(home_id, energy):
	...
	#step3	 Receive energy from other home
...
if __name__ == "__main__":
	...
	home1_process = multiprocessing.Process(target=home_process, args=(1, 20))
	home2_process = multiprocessing.Process(target=home_process, args=(2, 12))
	home3_process = multiprocessing.Process(target=home_process, args=(3, 7))
	home4_process = multiprocessing.Process(target=home_process, args=(4, 8))
	home1_process.start()
	home2_process.start()
	home3_process.start()
	home4_process.start()
